...
#     X_train, X_test, Y_train, Y_test = train_test_split(X, Y_7, test_size = 0.25, random_state = 100)
...
# depth_plot.set_title('Maximum Tree Depth vs Accuracy for 7 Classifications')
# plt.show()
...
#     # Training the model
#     rf_class_split = RandomForestClassifier(max_depth = 6, random_state = 42, min_samples_split = i)
...
# split_plot.set_title('Minimum Number of Samples for Split vs Accuracy for 7 Classifications')
# plt.show()
...
# Training the model
rf_class_best = RandomForestClassifier(max_depth = 6, random_state = 42, min_samples_split = 2)
...
plt.title('Confusion Matrix for 7 Classifications')
plt.show()
...
feature_imp.set_title('Feature Importance for 7 Classifications')
plt.tight_layout()
plt.show()
